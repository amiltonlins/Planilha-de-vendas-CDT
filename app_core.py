...
def team_performance_distribution(items,team_name):
...
@media(max-width:700px){
 ...
 [class*="st-key-seller_line_"] [data-testid="column"]:nth-child(4){grid-column:2!important}
    ...
    st.markdown("#### HISTÓRICO SEMANAL INDIVIDUAL")
    try:
    ...
    if history:
        ...
        st.caption("Importações recentes. Abra um registro somente quando precisar consultar detalhes ou excluir um lote ativo.")
...
@media(max-width:700px){
  ...
  .st-key-week_nav_buttons [data-testid="column"]:nth-child(6) button:after{content:"S6";font-size:.60rem!important;line-height:1!important}
    ...
    # Topo unificado conforme a referência visual, sem alterar dados ou regras.
...
/* FIX DEFINITIVO: BLOCOS TECNICOS DE CSS SEM ESPACO VERTICAL - 2026-08-24 */
