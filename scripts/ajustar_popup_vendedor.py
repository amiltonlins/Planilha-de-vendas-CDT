...
if old_view not in text:
    raise SystemExit('Bloco independente de performance não encontrado.')
...
section.main,
section.main>div,
.block-container{margin-top:0!important;padding-top:.35rem!important;min-height:0!important}
...
print('Ajustes de topo, produção e performance por equipe aplicados.')
