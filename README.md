...
- **DIÁRIO:** ranking do dia corrente com todos os vendedores ativos do painel, inclusive zerados; mostra vendas de hoje, acumulado da semana, Neoenergia de hoje, totais diários, semanais e Neoenergia das equipes Interna/Externa e download em PNG. Cada linha recebe a cor e o emoji das vendas do dia: 3 ou mais azul, 2 verde, 1 amarelo e 0 vermelho;
